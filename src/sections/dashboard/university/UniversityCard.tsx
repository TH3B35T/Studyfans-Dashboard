...
// PROJECT IMPORTS
import CustomerModal from './UniversityModal';
import CustomerPreview from './UniversityPreview';
import AlertCustomerDelete from './AlertUniversityDelete';
...
// TYPES
import { CustomerList } from 'types/dashboard/university';
